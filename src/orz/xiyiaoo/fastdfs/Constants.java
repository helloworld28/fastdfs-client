...
public class Constants {
    ...
    /**
     * 每个group的占用的response body的字节长度
     */
    public static final int GROUP_BYTE_LENGTH = FDFS_GROUP_NAME_MAX_LEN + 1 + FDFS_PROTO_PKG_LEN_SIZE * 11;
    /**
     * 每个storage的占用的response body的字节长度
     */
    public static final int STORAGE_BYTE_LENGTH = 1 + FDFS_STORAGE_ID_MAX_SIZE + FDFS_IPADDR_SIZE
            + FDFS_DOMAIN_NAME_MAX_SIZE + FDFS_IPADDR_SIZE + FDFS_VERSION_SIZE
            + FDFS_PROTO_PKG_LEN_SIZE * 52 + 1;
}
